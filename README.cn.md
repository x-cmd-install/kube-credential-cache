...
[![x-cmd/install — kube-credential-cache Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/kube-credential-cache.svg?lang=zh)](https://x-cmd.com/install/kube-credential-cache)
...
合计: **4,005** 行代码（覆盖前 5 种语言、共 **16** 个文件）。
...
- **上游仓库**: <https://github.com/ryodocx/kube-credential-cache>
- **许可证**: MIT
...
- **Star**: 15 · **Fork**: 0 · **开放 issue**: 2 · **贡献者**: 1

## 累计统计

- **发布数**: 20 · **已合并 PR**: 48 · **开放 PR**: 9 · **已关闭 issue**: 1 · **开放 issue**: 1 · **提交数**: 191
...
| last180d | 2026-03-29 | 0 | 3 | 6 | 0 | 1 | 4 |
| 360d | 2025-09-30 | 0 | 3 | 6 | 0 | 1 | 4 |
| last720d | 2024-10-05 | 0 | 3 | 7 | 0 | 1 | 7 |
...
kube-credential-cache 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `kube-credential-cache` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/kube-credential-cache.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:24:05Z._
